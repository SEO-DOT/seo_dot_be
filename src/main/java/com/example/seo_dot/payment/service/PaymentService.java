...
import com.example.seo_dot.payment.domain.PaymentStatus;
import com.example.seo_dot.payment.model.PaymentCallbackRequest;
import com.example.seo_dot.payment.model.RequestPayDto;
...
public class PaymentService {
    ...
    public RequestPayDto findRequestPayDto(String orderUid) {
        Order order = orderRepository.findByOrderUid(orderUid).orElseThrow();
